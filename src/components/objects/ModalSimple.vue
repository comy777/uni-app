<template>
    <TransitionRoot as="template" :show="modelValue">
        <Dialog as="div" class="absolute inset-0 z-40 overflow-y-auto" @close="clicked">
                    ...
                    <div
                        ...
                        <div class="sm:flex sm:items-start">
                            ...
                            <div class="text-center sm:mt-0 sm:ml-4 sm:text-left">
                                ...
                                <DialogTitle as="h3" :class="['mt-2 leading-6', titleSize]">{{ title
                                }}</DialogTitle>
                            </div>
                        </div>
...
export default defineComponent({
    props: {
        ...
        titleSize: {
            type: String,
            default: 'text-lg font-medium text-gray-900',
        },
    },
    components: {
        Dialog,
